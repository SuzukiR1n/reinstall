...
set confhome=https://raw.githubusercontent.com/SuzukiR1n/reinstall/main
rem set confhome_cn=https://cnb.cool/bin456789/reinstall/-/git/raw/main
set confhome_cn=https://gh-proxy.org/https://raw.githubusercontent.com/SuzukiR1n/reinstall/main
